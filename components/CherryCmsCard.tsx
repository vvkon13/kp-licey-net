...
export function CherryCmsCard() {
  ...
  const items = [
    "Разработчик: cherepkova.ru (единственная точка поддержки)",
    "Нет публичной документации",
    "Сложно найти разработчиков, знакомых с системой",
    "Менеджеры работают в привычном интерфейсе",
    "Ввод товаров и управление заказами работают стабильно",
  ];
